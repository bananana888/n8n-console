...
1. 下载 [`n8n-console-setup.exe`](https://github.com/bananana888/n8n-/releases/latest/download/n8n-console-setup.exe)（或 [`setup.msi`](https://github.com/bananana888/n8n-/releases/latest/download/setup.msi)）到 Windows x64 电脑
